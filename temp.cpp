...
int main(){
	...
	while(true){
		...
		cout << endl << "GRUPPI GENERATI E IN CODA" << endl;
		Sleep(100);
		...
		for(int i=0; i<coda.size(); i++){
			if(pista.canAddGroup(coda[i])){
				...
				cout << "\tGRUPPI POSSONO ENTRARE" << endl;
		...
		cout << endl << "GRUPPI ENTRATI" << endl << endl;
		Sleep(100);
		...
		cout << endl << "GRUPPI IN PISTA IN LOG" << endl;
		Sleep(100);
